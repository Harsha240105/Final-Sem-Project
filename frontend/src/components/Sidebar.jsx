...
import {
  ...
  ShoppingCart, Compass, Trophy, Award, Link2, Settings,
} from "lucide-react";
...
const baseLinks = [
  ...
  { to: "/leaderboard", label: "Leaderboard", icon: Trophy, color: "from-amber-500 to-orange-500", glow: "shadow-amber-500/20" },
